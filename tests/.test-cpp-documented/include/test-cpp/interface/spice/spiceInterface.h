 ...
 *        Value of ephemeris time at which rotation is to be determined. * @return None 
 */
 ...
 *
 * @param body
 *        Name of the body of which the parameter is to be retrieved. * @return None 
 */
 ...
 *
 * @param body
 *        Name of the body of which the average radius is to be retrieved. * @return None 
 */
 ...
 *
 * @param body_name
 *        Name of the body for which NAIF id is to be retrieved. * @return None 
 */
 ...
 *        Name of the property of which the presence is to be checked, not case-sensitive. * @return None 
 */
